...
[Snoop Full version database 3900+ websites ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "Database Snoop")  
...
search arguments:
  ...
  --web-base, -w        Connect to search for 'nickname' to the updated web_DB
                        (3900+ websites). In demo version the function is disabled
  --site , -s <site_name> 
