...
Иногда: при частом повторном сканировании — сервер конкретного ресурса может заблочить ip-адрес клиента на непродолжительное время.  
При использовании Snoop с IP адреса провайдера мобильного оператора скорость **может** упасть в разы, зависит от провайдера.  
Самый действенный способ решить проблему — **ИСПОЛЬЗОВАТЬ VPN**, Tor слабо подходит на роль помощника.  
