...
[Snoop full version database 2800+ websites ⚡️⚡️⚡️](https://github.com/snooppr/snoop/blob/master/websites.md "Database Snoop")  
...
$ apt-get install ttf-ancient-fonts или цветной (рекоменд.) $ apt-get install fonts-noto-color-emoji
...
search arguments:
  ...
  --web-base, -w        Подключиться для поиска 'nickname' к
                        динамично-обновляемой web_БД (2800+ сайтов). В demo
