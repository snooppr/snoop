...
<a href="https://raw.githubusercontent.com/snooppr/snoop/master/websites.md" Target="_blank"><img src="https://img.shields.io/badge/Snoop-~4400+%20sitios web-success" width="50%" /></a>  
...
[Base de datos de la versión completa de Snoop Más de 4400+ sitios web ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "Database Snoop")  
...
argumentos de búsqueda:
  ...
  --web-base, -w        Conéctese a una web_DB dinámicamente actualizada
                        (más de 4400+ sitios) para buscar 'apodo'.
...
$ snoop_cli -t 6 -f -S -u ~/file.txt -w #Ejecutando desde la versión de linux
