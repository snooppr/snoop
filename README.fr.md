...
<img src="https://img.shields.io/badge/Snoop-~4300+%20sites Internet-success" width="50%" />  
...
[Base de données de la version complète de Snoop 4300+ sites Web ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "Database Snoop")  
...
search arguments:
  ...
  --web-base, -w        Connectez-vous pour rechercher 'surnom' dans la base de
                        données web mise à jour (plus de 4300+ sites Web). 
