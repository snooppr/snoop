...
[Base de données de la version complète de Snoop 2900+ sites Web ⚡️⚡️⚡️](https://github.com/snooppr/snoop/blob/master/websites.md "Database Snoop")  
...
search arguments:
  ...
  --web-base, -w        Connectez-vous pour rechercher 'surnom' dans la base de
                        données web mise à jour (plus de 2900+ sites Web). 
