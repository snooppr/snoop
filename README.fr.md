...
<img src="https://img.shields.io/badge/Snoop-~2800+%20sites Internet-success" width="30%" />  
...
[Base de données de la version complète de Snoop 2800+ sites Web ⚡️⚡️⚡️](https://github.com/snooppr/snoop/blob/master/websites.md "Database Snoop")  
...
search arguments:
  ...
  --web-base, -w        Connectez-vous pour rechercher 'surnom' dans la base de
                        données web mise à jour (plus de 2800+ sites Web). 
