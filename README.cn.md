...
数据库索引等工具的比较：  
<img src="https://img.shields.io/badge/Snoop-~4300+%20网站-success" width="50%" />  
...
[Snoop 完整版数据库 4300+ 个网站 ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "数据库探听")  
...
search arguments:
  ...
  --web-base, -w        连接以在更新的 web_DB（4300+ 多个网站）中搜索'昵称'。 在演示版本中，
                        该功能被禁用
  --site , -s <site_name> 
