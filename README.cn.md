...
数据库索引等工具的比较：  
<a href="https://raw.githubusercontent.com/snooppr/snoop/master/websites.md" Target="_blank"><img src="https://img.shields.io/badge/Snoop-~4600+%20网站-success" width="50%" /></a>  
...
[Snoop 完整版数据库 4600+ 个网站 ⚡️⚡️⚡️](https://raw.githubusercontent.com/snooppr/snoop/master/websites.md "数据库探听")  
...
search arguments:
  ...
  --pool , -p <digit> 
                        禁用自动优化并将手动搜索加速设置为最大 1 到 300。工作线程/进程。
